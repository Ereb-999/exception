...
public class Main {
    ...
    public static void checkLogin(String login) throws WrongLoginException{
        if(login.length() >= 20){
            throw new WrongLoginException("Ошибка! Был превышен лимит логина!");
        }
    ...
    public static void checkPasswords(String password, String confirmPassword) throws WrongPasswordException{
        ...
        if(!password.equals(confirmPassword)){
            throw new WrongPasswordException("Ошибка! Пароли должны быть одинаковыми!");
        }

        if(password.length() >= 20){
            throw new WrongPasswordException("Ошибка! Был превышен лимит логина!");
        }
